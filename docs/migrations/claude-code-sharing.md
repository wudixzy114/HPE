...
- `app.js`: global navigation, notes, fullscreen, pointer spotlight and scaling;
...
- global navigation, URL state, notes, fullscreen, overview, speaker view and print now use engine/player capabilities; the legacy pointer spotlight was replaced with a slide annotation canvas.
...
4. notes and an on-slide pen needed standard presentation controls;
...
- notes, annotation pen, Home/End, speaker synchronization and 50-page print are covered by Chromium E2E;
